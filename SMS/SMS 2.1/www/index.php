					...
					<div class="panel-group" id="accordion">
								...
								<div class="panel-body">
									<form action="acao.php" method="post" name="formulario" id="formulario">
										<p>
											...
											para acessar a rede wifi ALERGS PÚBLICO.</p>
										...
										<?php
											...
											$publickey = "6LdkIPESAAAAABbPR4nArHvQW8p2IyA1plkJri7v";
						...
						<div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse">
								<div class="panel-body">
									<form method="post" action="http://10.0.3.254:8000/">
									<input name="redirurl" type="hidden" value="http://www.al.rs.gov.br/">
										<div class="input-group">
											<span class="input-group-addon">Código de Acesso</span>
											<input name="auth_voucher" type="text" class="form-control" placeholder="Ex: E5B9XC10">
										</div>
										<div class="btn-group">
								...
								<div class="panel-body">
									...
									<input name="redirurl" type="hidden" value="http://www.al.rs.gov.br/">								
										...
										<div class="input-group">
											...
											<input name="auth_pass" type="text" class="form-control" placeholder="Senha de rede">
										</div>
										<div class="btn-group">
											<button class="btn btn-default" name="accept" type="submit">
												ENTRAR</button>
